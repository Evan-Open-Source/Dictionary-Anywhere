...
function saveOptions(e) {
  browser.storage.local
    .set({
      ...
      authToken: document.querySelector("#user-slack-bearer-token").value,
      channel: document.querySelector("#slack-channel").value,
    })
...
function restoreOptions() {
  ...
  storageItem.then((results) => {
    ...
    document.querySelector("#user-slack-bearer-token").value = authToken;
    document.querySelector("#slack-channel").value = channel;
  });
}
